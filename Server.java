...
import java.awt.*;        //color property
...
{ 
        ...
        JLabel morovert = new JLabel (i15);
        morovert.setBounds(420,20,10,25);
        p1.add(morovert);
        
        JLabel name = new JLabel("Harshit");
        ...
        status.setBounds(106,40,100,14);
        ...
        p1.add(status);
         ...
         text= new JTextField();
         text.setBounds(5,625,310,40);
         text.setFont(new Font ("SAN_SERIF",Font.PLAIN,20));
          f.add(text);

        JButton send = new JButton("Send");
        send.setBounds(320,625,123,40);
